...
public class Main {
    ...
    public static void makeRecord() throws Exception{
        System.out.println("Введите Фамилию Имя Отчество дату_рождения(в формате dd.mm.yyyy) номер_телефона(число без разделителей) и пол(символ латиницей f или m), разделенные пробелом?: ");
